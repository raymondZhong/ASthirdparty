package feathers.examples.tileList
{
	...
	public class Main extends Sprite
	{
		...
		private function list_changeHandler(e:Event):void 
		{
			...
			var d:*= list.selectedItem;
			trace(collection.getItemAt(list.selectedIndex).label)
		}
		...
		protected function tileListItemRendererFactory():IListItemRenderer
		{
			...
			renderer.defaultSelectedIcon = new Image(_iconAtlas.getTexture("facebook"))
			renderer.defaultLabelProperties.textFormat = new BitmapFontTextFormat(this._font, NaN, 0x000000);
		//	renderer.addEventListener(Event.TRIGGERED, xxxx);
			return renderer;
		}
