package fr.kikko.lab {
	...
	import zebraAir.util.FileHelper;
	...
	public class ShineMP3Encoder extends EventDispatcher {
		...
		//public function saveTo(filename:String,suffix:String = ".mp3"):void {
		public function saveTo(filename:String):void {
			 //var file:File = new File(File.userDirectory.nativePath + "/miyu/audio/" + filename+suffix);
			  var file:File = new File(File.userDirectory.nativePath + "/miyu/audio/" + filename);
			  FileHelper.saveFile(file, mp3Data);
			  saveFilePath = file.url;
